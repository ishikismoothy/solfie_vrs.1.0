<!--widgetB.vue : Body Emotion Mind Spirit-->
<template>
    ...
    <section v-if="!isDataLoading && selectedDataTab !== 'アドバイス' && currentDataValues.items && Object.keys(currentDataValues.items).length > 0" class="chart-content-section">
      ...
      <div class="chart-circle">
        <svg width="0" height="0">
          <defs>
            <linearGradient id="chartGradientB" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <svg viewBox="0 0 100 100">
          ...
          <circle cx="50" cy="50" r="45" fill="none" stroke="url(#chartGradientB)" stroke-width="10"
...
export default defineComponent({
  ...
  props: {
    ...
    tabKey: {
      type: String,
      default: 'bodyEmotionMindSpirit'  // Fixed: Updated default
    },
    tabType: {
      type: String,
      default: 'tab_B'  // Fixed: Updated default
    },
    // Getter name for data
    dataGetterName: {
      type: String,
      default: 'getDataB'  // Fixed: Updated default
    },
    // State path to chart data
    dataStatePath: {
      type: String,
      default: 'analysisData.data_B'  // Fixed: Updated default
    },
    // State path to advice data
    adviceStatePath: {
      type: String,
      default: 'analysisData.advice_B'  // Fixed: Updated default
    },
    // Getter name for advice date info
    adviceDateInfoGetterName: {
      type: String,
      default: 'getAdviceDateInfoB'
    },
    ...
    widgetConfig: {
      type: String,
      default: 'data_B'  // Fixed: Updated default
    }
  },
  setup(props) {

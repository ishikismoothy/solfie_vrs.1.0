  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const selectScoreTab = (tab) => {
        store.dispatch('scores/selectScoreTab', tab);
      };
      ...
      const initializeAnimatedScores = () => {
        const scoresData = store.state.scores.scoresData;
...
const selectAbilityTab = (tab) => {
  store.dispatch('abilities/selectAbilityTab', tab);
};
...
const initializeAnimatedAbilities = () => {
  const abilitiesData = store.state.abilities.abilitiesData;
